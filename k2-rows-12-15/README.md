...
`ours` is the elementary counting lemma in `ramsey/scripts/lemma/counting_bound.py` of the working repository.

| cell | prev | lower (here) | upper | source of upper | LM | witness | shape |
|---|---:|---:|---:|---|---:|---|---|
| R(K2,12; K2,3) | 22 | **23** | 24 | counting lemma (ours) | 27 | `witness_k2x12k2x3_n22_semireg2.txt` | 11 x 2 |
| R(K2,12; K2,4) | 25 | **26** | 27 | counting lemma (ours) | 29 | `witness_k2x12k2x4_n25_semireg5.txt` | 5 x 5 |
| R(K2,12; K2,5) | 28 | **29** | 30 | counting lemma (ours) | 31 | `witness_k2x12k2x5_n28_semireg7.txt` | 4 x 7 |
| R(K2,12; K2,6) | 29 | **31** | 32 | counting lemma (ours) | 33 | `witness_k2x12k2x6_n30_semireg15.txt` | 2 x 15 |
...
| R(K2,13; K2,3) | 22 | **25** | 26 | counting lemma (ours) | 29 | `witness_k2x13k2x3_n24_semireg12.txt` | 2 x 12 |
| R(K2,13; K2,4) | 26 | **28** | 29 | counting lemma (ours) | 31 | `witness_k2x13k2x4_n27_semireg9.txt` | 3 x 9 |
| R(K2,13; K2,5) | 28 | **31** | 32 | counting lemma (ours) | 33 | `witness_k2x13k2x5_n30_semireg10.txt` | 3 x 10 |
| R(K2,13; K2,6) | 29 | **32** | 34 | counting lemma (ours) | 35 | `witness_k2x13k2x6_n31_semireg10f1.txt` | 3 x 10 + 1 fixed |
| R(K2,13; K2,9) | 37 | **41** | 41 | Lortz-Mengersen (published) | 41 | `witness_k2x13k2x9_n40_semireg20.txt` | 2 x 20 |
| R(K2,14; K2,3) | 22 | **26** | 27 | counting lemma (ours) | 31 | `witness_k2x14k2x3_n25_semireg5.txt` | 5 x 5 |
| R(K2,14; K2,4) | 26 | **29** | 30 | counting lemma (ours) | 33 | `witness_k2x14k2x4_n28_semireg14.txt` | 2 x 14 |
| R(K2,14; K2,5) | 28 | **31** | 33 | counting lemma (ours) | 35 | `witness_k2x14k2x5_n30_semireg30.txt` | 1 x 30 |
| R(K2,14; K2,6) | 29 | **34** | 36 | counting lemma (ours) | 37 | `witness_k2x14k2x6_n33_semireg11.txt` | 3 x 11 |
| R(K2,14; K2,9) | 37 | **43** | 43 | Lortz-Mengersen (published) | 43 | `witness_k2x14k2x9_n42_semireg21.txt` | 2 x 21 |
| R(K2,15; K2,3) | 24 | **27** | 28 | counting lemma (ours) | 33 | `witness_k2x15k2x3_n26_semireg13.txt` | 2 x 13 |
| R(K2,15; K2,4) | 26 | **30** | 32 | counting lemma (ours) | 35 | `witness_k2x15k2x4_n29_semireg7f1.txt` | 4 x 7 + 1 fixed |
| R(K2,15; K2,5) | 28 | **33** | 35 | counting lemma (ours) | 37 | `witness_k2x15k2x5_n32_semireg16.txt` | 2 x 16 |
| R(K2,15; K2,6) | 29 | **35** | 37 | counting lemma (ours) | 39 | `witness_k2x15k2x6_n34_semireg17.txt` | 2 x 17 |
...
The other sixteen are windows of width 1 to 3. In those the upper bound is our own counting lemma, which is 1 to 6 below
the Lortz-Mengersen general bound; the lower bound is the colouring deposited here. Closing one needs either a colouring
...
of these cells cannot be excluded, and the counting upper bounds may not be new either. The flag-algebra and
